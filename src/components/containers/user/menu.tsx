...
import type { UserMenuProps } from "@/models/types/components/user";

/**
 * User menu component
 *
 * Displays user avatar, name, email, and dropdown menu with actions.
 * Fetches user session data and provides sign-out functionality.
 *
 * @param className - Optional additional CSS classes
 * @param props - Additional menu props
 */
