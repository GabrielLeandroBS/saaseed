...
/**
 * Team switcher component for sidebar
 *
 * Displays team selection dropdown with team logos and plans.
 * Allows users to switch between different teams/organizations.
 *
 * @param teams - Array of team objects with name, logo, and plan
 * @param className - Optional additional CSS classes
 * @param props - Additional team switcher props
 */
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid flex-1">
                ...
                <Text as="span" size="xs" leading="tight" className="truncate">
                  {activeTeam.plan}
                </Text>
              </div>
