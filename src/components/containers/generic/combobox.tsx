 ...
 *
 * Provides a searchable select input with options.
 * Supports keyboard navigation, translations, and custom rendering.
 *
 ...
 * @param translations - Translation dictionary for labels
 * @param onValueChange - Callback when value changes
 * @param className - Optional additional CSS classes
 * @param props - Additional combobox props
 */
